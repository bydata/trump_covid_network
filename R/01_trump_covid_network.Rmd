...
Disclaimer: This exercise is completely unscientific. Just some pet project scraping and data visualization. I'm not neither an epidemiologist nor virologist.
...
```{r network_vis, fig.width=8, fig.height=6}
